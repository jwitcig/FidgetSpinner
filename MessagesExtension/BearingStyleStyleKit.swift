...
public class BearingStyleStyleKit : NSObject {
    ...
    public dynamic class func drawBearing2(frame targetFrame: CGRect = CGRect(x: 0, y: 0, width: 300, height: 300), resizing: ResizingBehavior = .aspectFit, bearingColorParam: UIColor = UIColor(red: 0.623, green: 0.623, blue: 0.623, alpha: 1.000)) {
        ...
        bezierPath.move(to: CGPoint(x: 150.5, y: 77.32))
        bezierPath.addCurve(to: CGPoint(x: 77.43, y: 150.25), controlPoint1: CGPoint(x: 110.15, y: 77.32), controlPoint2: CGPoint(x: 77.43, y: 109.97))
        bezierPath.addCurve(to: CGPoint(x: 150.5, y: 223.18), controlPoint1: CGPoint(x: 77.43, y: 190.53), controlPoint2: CGPoint(x: 110.15, y: 223.18))
        bezierPath.addCurve(to: CGPoint(x: 223.58, y: 150.25), controlPoint1: CGPoint(x: 190.86, y: 223.18), controlPoint2: CGPoint(x: 223.58, y: 190.53))
        bezierPath.addCurve(to: CGPoint(x: 150.5, y: 77.32), controlPoint1: CGPoint(x: 223.58, y: 109.97), controlPoint2: CGPoint(x: 190.86, y: 77.32))
        bezierPath.close()
        bezierPath.move(to: CGPoint(x: 277, y: 150))
        bezierPath.addCurve(to: CGPoint(x: 150, y: 277), controlPoint1: CGPoint(x: 277, y: 220.14), controlPoint2: CGPoint(x: 220.14, y: 277))
        bezierPath.addCurve(to: CGPoint(x: 23, y: 150), controlPoint1: CGPoint(x: 79.86, y: 277), controlPoint2: CGPoint(x: 23, y: 220.14))
        bezierPath.addCurve(to: CGPoint(x: 150, y: 23), controlPoint1: CGPoint(x: 23, y: 79.86), controlPoint2: CGPoint(x: 79.86, y: 23))
        bezierPath.addCurve(to: CGPoint(x: 277, y: 150), controlPoint1: CGPoint(x: 220.14, y: 23), controlPoint2: CGPoint(x: 277, y: 79.86))
        bezierPath.close()
        ...
        oval4Path.move(to: CGPoint(x: 275, y: 150))
        oval4Path.addCurve(to: CGPoint(x: 150, y: 275), controlPoint1: CGPoint(x: 275, y: 219.03), controlPoint2: CGPoint(x: 219.04, y: 275))
        oval4Path.addCurve(to: CGPoint(x: 25, y: 150), controlPoint1: CGPoint(x: 80.96, y: 275), controlPoint2: CGPoint(x: 25, y: 219.03))
        oval4Path.addCurve(to: CGPoint(x: 150, y: 25), controlPoint1: CGPoint(x: 25, y: 80.97), controlPoint2: CGPoint(x: 80.96, y: 25))
        oval4Path.addCurve(to: CGPoint(x: 275, y: 150), controlPoint1: CGPoint(x: 219.04, y: 25), controlPoint2: CGPoint(x: 275, y: 80.97))
        oval4Path.addLine(to: CGPoint(x: 256.62, y: 150))
        oval4Path.addCurve(to: CGPoint(x: 150, y: 43.35), controlPoint1: CGPoint(x: 256.62, y: 91.09), controlPoint2: CGPoint(x: 208.88, y: 43.35))
        oval4Path.addCurve(to: CGPoint(x: 43.38, y: 150), controlPoint1: CGPoint(x: 91.12, y: 43.35), controlPoint2: CGPoint(x: 43.38, y: 91.09))
        oval4Path.addCurve(to: CGPoint(x: 150, y: 256.65), controlPoint1: CGPoint(x: 43.38, y: 208.91), controlPoint2: CGPoint(x: 91.12, y: 256.65))
        oval4Path.addCurve(to: CGPoint(x: 256.62, y: 150), controlPoint1: CGPoint(x: 208.88, y: 256.65), controlPoint2: CGPoint(x: 256.62, y: 208.91))
        oval4Path.addLine(to: CGPoint(x: 275, y: 150))
        oval4Path.close()
        context.saveGState()
        ...
        ovalPath.move(to: CGPoint(x: 277, y: 150))
        ovalPath.addCurve(to: CGPoint(x: 150, y: 277), controlPoint1: CGPoint(x: 277, y: 220.14), controlPoint2: CGPoint(x: 220.14, y: 277))
        ovalPath.addCurve(to: CGPoint(x: 23, y: 150), controlPoint1: CGPoint(x: 79.86, y: 277), controlPoint2: CGPoint(x: 23, y: 220.14))
        ovalPath.addCurve(to: CGPoint(x: 150, y: 23), controlPoint1: CGPoint(x: 23, y: 79.86), controlPoint2: CGPoint(x: 79.86, y: 23))
        ovalPath.addCurve(to: CGPoint(x: 277, y: 150), controlPoint1: CGPoint(x: 220.14, y: 23), controlPoint2: CGPoint(x: 277, y: 79.86))
        ovalPath.addLine(to: CGPoint(x: 258.32, y: 150))
        ovalPath.addCurve(to: CGPoint(x: 150, y: 41.64), controlPoint1: CGPoint(x: 258.32, y: 90.15), controlPoint2: CGPoint(x: 209.82, y: 41.64))
        ovalPath.addCurve(to: CGPoint(x: 41.68, y: 150), controlPoint1: CGPoint(x: 90.18, y: 41.64), controlPoint2: CGPoint(x: 41.68, y: 90.15))
        ovalPath.addCurve(to: CGPoint(x: 150, y: 258.36), controlPoint1: CGPoint(x: 41.68, y: 209.85), controlPoint2: CGPoint(x: 90.18, y: 258.36))
        ovalPath.addCurve(to: CGPoint(x: 258.32, y: 150), controlPoint1: CGPoint(x: 209.82, y: 258.36), controlPoint2: CGPoint(x: 258.32, y: 209.85))
        ovalPath.addLine(to: CGPoint(x: 277, y: 150))
        ovalPath.close()
        darkMetal.setFill()
        ovalPath.fill()
        ...
        oval2Path.move(to: CGPoint(x: 221, y: 150))
        oval2Path.addCurve(to: CGPoint(x: 150, y: 221), controlPoint1: CGPoint(x: 221, y: 189.21), controlPoint2: CGPoint(x: 189.21, y: 221))
        oval2Path.addCurve(to: CGPoint(x: 79, y: 150), controlPoint1: CGPoint(x: 110.79, y: 221), controlPoint2: CGPoint(x: 79, y: 189.21))
        oval2Path.addCurve(to: CGPoint(x: 150, y: 79), controlPoint1: CGPoint(x: 79, y: 110.79), controlPoint2: CGPoint(x: 110.79, y: 79))
        oval2Path.addCurve(to: CGPoint(x: 221, y: 150), controlPoint1: CGPoint(x: 189.21, y: 79), controlPoint2: CGPoint(x: 221, y: 110.79))
        oval2Path.addLine(to: CGPoint(x: 203.25, y: 150))
        oval2Path.addCurve(to: CGPoint(x: 150, y: 96.75), controlPoint1: CGPoint(x: 203.25, y: 120.59), controlPoint2: CGPoint(x: 179.41, y: 96.75))
        oval2Path.addCurve(to: CGPoint(x: 96.75, y: 150), controlPoint1: CGPoint(x: 120.59, y: 96.75), controlPoint2: CGPoint(x: 96.75, y: 120.59))
        oval2Path.addCurve(to: CGPoint(x: 150, y: 203.25), controlPoint1: CGPoint(x: 96.75, y: 179.41), controlPoint2: CGPoint(x: 120.59, y: 203.25))
        oval2Path.addCurve(to: CGPoint(x: 203.25, y: 150), controlPoint1: CGPoint(x: 179.41, y: 203.25), controlPoint2: CGPoint(x: 203.25, y: 179.41))
        oval2Path.addLine(to: CGPoint(x: 221, y: 150))
        oval2Path.close()
        darkMetal.setFill()
        oval2Path.fill()
        ...
        oval3Path.move(to: CGPoint(x: 234, y: 150.5))
        oval3Path.addCurve(to: CGPoint(x: 149.5, y: 235), controlPoint1: CGPoint(x: 234, y: 197.17), controlPoint2: CGPoint(x: 196.17, y: 235))
        oval3Path.addCurve(to: CGPoint(x: 65, y: 150.5), controlPoint1: CGPoint(x: 102.83, y: 235), controlPoint2: CGPoint(x: 65, y: 197.17))
        oval3Path.addCurve(to: CGPoint(x: 149.5, y: 66), controlPoint1: CGPoint(x: 65, y: 103.83), controlPoint2: CGPoint(x: 102.83, y: 66))
        oval3Path.addCurve(to: CGPoint(x: 234, y: 150.5), controlPoint1: CGPoint(x: 196.17, y: 66), controlPoint2: CGPoint(x: 234, y: 103.83))
        oval3Path.addLine(to: CGPoint(x: 212.88, y: 150.5))
        oval3Path.addCurve(to: CGPoint(x: 149.5, y: 87.12), controlPoint1: CGPoint(x: 212.88, y: 115.5), controlPoint2: CGPoint(x: 184.5, y: 87.13))
        oval3Path.addCurve(to: CGPoint(x: 86.12, y: 150.5), controlPoint1: CGPoint(x: 114.5, y: 87.12), controlPoint2: CGPoint(x: 86.13, y: 115.5))
        oval3Path.addCurve(to: CGPoint(x: 149.5, y: 213.88), controlPoint1: CGPoint(x: 86.12, y: 185.5), controlPoint2: CGPoint(x: 114.5, y: 213.88))
        oval3Path.addCurve(to: CGPoint(x: 212.88, y: 150.5), controlPoint1: CGPoint(x: 184.5, y: 213.88), controlPoint2: CGPoint(x: 212.88, y: 185.5))
        oval3Path.addLine(to: CGPoint(x: 234, y: 150.5))
        oval3Path.close()
        context.saveGState()
        ...
        oval5Path.move(to: CGPoint(x: 230, y: 150))
        oval5Path.addCurve(to: CGPoint(x: 150, y: 230), controlPoint1: CGPoint(x: 230, y: 194.18), controlPoint2: CGPoint(x: 194.18, y: 230))
        oval5Path.addCurve(to: CGPoint(x: 70, y: 150), controlPoint1: CGPoint(x: 105.82, y: 230), controlPoint2: CGPoint(x: 70, y: 194.18))
        oval5Path.addCurve(to: CGPoint(x: 150, y: 70), controlPoint1: CGPoint(x: 70, y: 105.82), controlPoint2: CGPoint(x: 105.82, y: 70))
        oval5Path.addCurve(to: CGPoint(x: 230, y: 150), controlPoint1: CGPoint(x: 194.18, y: 70), controlPoint2: CGPoint(x: 230, y: 105.82))
        oval5Path.addLine(to: CGPoint(x: 210, y: 150))
        oval5Path.addCurve(to: CGPoint(x: 150, y: 90), controlPoint1: CGPoint(x: 210, y: 116.86), controlPoint2: CGPoint(x: 183.14, y: 90))
        oval5Path.addCurve(to: CGPoint(x: 90, y: 150), controlPoint1: CGPoint(x: 116.86, y: 90), controlPoint2: CGPoint(x: 90, y: 116.86))
        oval5Path.addCurve(to: CGPoint(x: 150, y: 210), controlPoint1: CGPoint(x: 90, y: 183.14), controlPoint2: CGPoint(x: 116.86, y: 210))
        oval5Path.addCurve(to: CGPoint(x: 210, y: 150), controlPoint1: CGPoint(x: 183.14, y: 210), controlPoint2: CGPoint(x: 210, y: 183.14))
        oval5Path.addLine(to: CGPoint(x: 230, y: 150))
        oval5Path.close()
    ...
    public dynamic class func drawBearing3(frame targetFrame: CGRect = CGRect(x: 0, y: 0, width: 300, height: 300), resizing: ResizingBehavior = .aspectFit) {
        ...
        //// Bezier Drawing
        let bezierPath = UIBezierPath()
        bezierPath.move(to: CGPoint(x: 150.5, y: 78))
        bezierPath.addCurve(to: CGPoint(x: 78, y: 150.5), controlPoint1: CGPoint(x: 110.46, y: 78), controlPoint2: CGPoint(x: 78, y: 110.46))
        bezierPath.addCurve(to: CGPoint(x: 150.5, y: 223), controlPoint1: CGPoint(x: 78, y: 190.54), controlPoint2: CGPoint(x: 110.46, y: 223))
        bezierPath.addCurve(to: CGPoint(x: 223, y: 150.5), controlPoint1: CGPoint(x: 190.54, y: 223), controlPoint2: CGPoint(x: 223, y: 190.54))
        bezierPath.addCurve(to: CGPoint(x: 150.5, y: 78), controlPoint1: CGPoint(x: 223, y: 110.46), controlPoint2: CGPoint(x: 190.54, y: 78))
        bezierPath.close()
        bezierPath.move(to: CGPoint(x: 276, y: 150.25))
        bezierPath.addCurve(to: CGPoint(x: 150, y: 276.5), controlPoint1: CGPoint(x: 276, y: 219.98), controlPoint2: CGPoint(x: 219.59, y: 276.5))
        bezierPath.addCurve(to: CGPoint(x: 24, y: 150.25), controlPoint1: CGPoint(x: 80.41, y: 276.5), controlPoint2: CGPoint(x: 24, y: 219.98))
        bezierPath.addCurve(to: CGPoint(x: 150, y: 24), controlPoint1: CGPoint(x: 24, y: 80.52), controlPoint2: CGPoint(x: 80.41, y: 24))
        bezierPath.addCurve(to: CGPoint(x: 276, y: 150.25), controlPoint1: CGPoint(x: 219.59, y: 24), controlPoint2: CGPoint(x: 276, y: 80.52))
        bezierPath.close()
        goldCeramic.setFill()
        bezierPath.fill()
    ...
    public dynamic class func drawBearing5(frame targetFrame: CGRect = CGRect(x: 0, y: 0, width: 300, height: 300), resizing: ResizingBehavior = .aspectFit, bearingColorParam: UIColor = UIColor(red: 0.623, green: 0.623, blue: 0.623, alpha: 1.000)) {
        ...
        //// Oval 6 Drawing
        let oval6Path = UIBezierPath(ovalIn: CGRect(x: 62, y: 63, width: 175, height: 175))
        bearingColorParam.setFill()
        oval6Path.fill()
    ...
    public dynamic class func drawBearing4(frame targetFrame: CGRect = CGRect(x: 0, y: 0, width: 300, height: 300), resizing: ResizingBehavior = .aspectFit, bearingColorParam: UIColor = UIColor(red: 0.623, green: 0.623, blue: 0.623, alpha: 1.000)) {
        ...
        //// Oval 4 Drawing
        let oval4Path = UIBezierPath()
        oval4Path.move(to: CGPoint(x: 251, y: 150.5))
        oval4Path.addCurve(to: CGPoint(x: 149.5, y: 252), controlPoint1: CGPoint(x: 251, y: 206.55), controlPoint2: CGPoint(x: 205.56, y: 252))
        oval4Path.addCurve(to: CGPoint(x: 48, y: 150.5), controlPoint1: CGPoint(x: 93.44, y: 252), controlPoint2: CGPoint(x: 48, y: 206.55))
        oval4Path.addCurve(to: CGPoint(x: 149.5, y: 49), controlPoint1: CGPoint(x: 48, y: 94.45), controlPoint2: CGPoint(x: 93.44, y: 49))
        oval4Path.addCurve(to: CGPoint(x: 251, y: 150.5), controlPoint1: CGPoint(x: 205.56, y: 49), controlPoint2: CGPoint(x: 251, y: 94.45))
        oval4Path.addLine(to: CGPoint(x: 236.07, y: 150.5))
        oval4Path.addCurve(to: CGPoint(x: 149.5, y: 63.9), controlPoint1: CGPoint(x: 236.07, y: 102.67), controlPoint2: CGPoint(x: 197.31, y: 63.9))
        oval4Path.addCurve(to: CGPoint(x: 62.93, y: 150.5), controlPoint1: CGPoint(x: 101.69, y: 63.9), controlPoint2: CGPoint(x: 62.93, y: 102.67))
        oval4Path.addCurve(to: CGPoint(x: 149.5, y: 237.1), controlPoint1: CGPoint(x: 62.93, y: 198.33), controlPoint2: CGPoint(x: 101.69, y: 237.1))
        oval4Path.addCurve(to: CGPoint(x: 236.07, y: 150.5), controlPoint1: CGPoint(x: 197.31, y: 237.1), controlPoint2: CGPoint(x: 236.07, y: 198.33))
        oval4Path.addLine(to: CGPoint(x: 251, y: 150.5))
        oval4Path.close()
        context.saveGState()
        context.setShadow(offset: CGSize(width: outerRimShadow.shadowOffset.width * resizedShadowScale, height: outerRimShadow.shadowOffset.height * resizedShadowScale), blur: outerRimShadow.shadowBlurRadius * resizedShadowScale, color: (outerRimShadow.shadowColor as! UIColor).cgColor)
        bearingColorParam.setFill()
